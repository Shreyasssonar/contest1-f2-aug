...
function addData() {
  //Write your code here, just console.log
  let newEmployee = {id:4, name:'Dhiraj', age:21, profession:'intern'};
...
function concatenateArray() {
  //Write your code here, just console.log
  let newEmployees = [
    { id: 4, name: 'om', age: 18, profession: 'Designer' },
    { id: 5, name: 'Shreyas', age: 20, profession: 'CEO'},
    { id: 6, name: 'shubham', age: 22, profession: 'Product Manager' },
  ];
